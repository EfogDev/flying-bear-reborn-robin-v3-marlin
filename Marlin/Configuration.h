...
#define STRING_CONFIG_H_AUTHOR "Efog" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Flying Bear"
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 4000, 4000, 200, 500 }
...
//#define NOZZLE_CLEAN_FEATURE
  ...
  // Move the nozzle to the initiaMarlinl position after cleaning
